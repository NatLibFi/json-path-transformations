(function() { 
    ...
    define(['es6-polyfills/lib/object', 'jsonpath', 'loglevel', 'json-schema-config', '../resources/transformations-schema.json'], function(Object, jsonpath, log, jsonSchemaConfig, transformations_schema) {
