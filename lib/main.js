...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define(['es6-polyfills/lib/polyfills/object', 'jsonpath', 'jjv', 'jjve', 'json!../resources/transformations-schema.json'], factory);
  } else if (typeof module === 'object' && module.exports) {
    module.exports = factory(require('es6-polyfills/lib/polyfills/object'), require('jsonpath'), require('jjv'), require('jjve'), require('../resources/transformations-schema.json'));
  }
...
function factory(Object, jsonpath, jjv, jjve, schema)
{
  ...
  {     
    try {
      ...
      spec.transformations.filter(function(transformation) {

        return transformation.disabled !== true;
